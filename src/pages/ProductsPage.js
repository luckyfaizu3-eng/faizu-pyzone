              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    color: '#fbbf24', padding: '0.5rem 0.875rem', borderRadius: '12px',
                ...
                <div style={{ padding: '1.5rem' }}>
                  <div style={{
                    ...
                    background: isDark ? 'rgba(139,92,246,0.2)' : 'rgba(99,102,241,0.1)',
                    color: isDark ? '#c4b5fd' : '#6366f1',
                    padding: '0.375rem 0.875rem', borderRadius: '16px',
                  ...
                  <h3 style={{
                    fontSize: '1.25rem', fontWeight: '800', marginBottom: '0.75rem',
                  ...
                  <p style={{
                    ...
                    marginBottom: '1.5rem', display: '-webkit-box', WebkitLineClamp: 2,
                  ...
                  {product.reviews && product.reviews.length > 0 && (
                    <div style={{ marginTop: '1rem', color: isDark ? '#94a3b8' : '#64748b', fontSize: '0.8rem', fontWeight: '600' }}>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h2 style={{ fontSize: isMobile ? '1.5rem' : '1.75rem', fontWeight: '900', color: isDark ? '#e2e8f0' : '#1e293b', margin: 0 }}>
                📚 Categories
              </h2>
              <button
                onClick={() => setShowCategoryModal(false)}
            ...
            <button
              ...
              style={{
                width: '100%',
                background: selectedCategory === 'all' ? 'linear-gradient(135deg, #6366f1, #8b5cf6)' : isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)',
                ...
                padding: '1rem 1.25rem', borderRadius: '16px', cursor: 'pointer',
            ...
            >
              ...
              <span style={{
                ...
                fontSize: '0.875rem', color: selectedCategory === 'all' ? '#fff' : '#6366f1'
              }}>
                {products.length}
              </span>
            </button>
              ...
              {allCategories.map(category => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: selectedCategory === category.id ? 'linear-gradient(135deg, #6366f1, #8b5cf6)' : isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)',
                      ...
                      display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '0.5rem', textAlign: 'left',
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      padding: '0.25rem 0.75rem', borderRadius: '12px',
                      fontSize: '0.75rem', color: selectedCategory === category.id ? '#fff' : '#6366f1'
                    }}>
