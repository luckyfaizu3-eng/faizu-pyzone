  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          color: '#fde68a',
          textShadow: '0 0 30px rgba(253,230,138,0.6)',
        }}>Skill</span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
        {FEATURES.map((f, i) => (
          <div key={i} style={{
            ...
            <div>
              <div style={{ fontSize: '0.74rem', fontWeight: 700, color: '#fff', lineHeight: 1.2 }}>
                {f.label}
              </div>
...
function SplashScreen({ onComplete }) {
  ...
  useEffect(() => {
    const t1 = setTimeout(() => setScreen(2), 3800);
    const t2 = setTimeout(() => setScreen(3), 8200);
  ...
  return (
    <div style={{
      ...
      <style>{`
        @keyframes logoPulse {
          0%,100% { box-shadow: 0 20px 60px rgba(0,0,0,0.25), 0 0 0 0 rgba(253,230,138,0); }
          50%      { box-shadow: 0 20px 60px rgba(0,0,0,0.25), 0 0 0 12px rgba(253,230,138,0.1); }
        }
